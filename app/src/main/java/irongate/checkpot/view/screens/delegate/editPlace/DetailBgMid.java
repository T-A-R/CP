...
public class DetailBgMid extends RelativeLayout {
    private Paint paintWhite;
    private Paint paintErase;
    private Paint paintLine;

    public DetailBgMid(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(0, 0, 8 * d, paintErase);
        canvas.drawCircle(width, 0, 8 * d, paintErase);
//        canvas.drawLine(25 * d, 0, width - 25 * d, 0, paintLine);

        canvas.drawCircle(0, height, 8 * d, paintErase);
        canvas.drawCircle(width, height, 8 * d, paintErase);
//        canvas.drawLine(25 * d, height, width - 25 * d, height, paintLine);
