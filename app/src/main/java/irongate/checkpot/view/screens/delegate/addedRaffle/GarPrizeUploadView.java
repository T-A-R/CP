...
public class GarPrizeUploadView extends RelativeLayout {
    ...
    public GarPrizeUploadView(Context context) {
        super(context);
        initComponent();
    }

    public GarPrizeUploadView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initComponent();
    }

    public GarPrizeUploadView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initComponent() {
        ...
        textImageTwo.setVisibility(GONE);
    }

    public void setLoadClickListener(OnClickListener onClickListener) {
